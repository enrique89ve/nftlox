...
| 3 | `transfer` | Active | Transfer or directly burn NFTs |
...
| 15 | `nft_approve` | Active | Approve one instance spender |
| 16 | `nft_approve_all` | Active | Approve a collection-wide spender |
| 17 | `nft_transfer_from` | Active | Transfer an instance using prior approval |
| 18 | `nft_lend` | Active | Lend an instance without changing ownership |
| 19 | `nft_return` | Active | Return a lent instance |
...
account `null` is rejected by `nft_transfer_from`; burning is available only
