...
| **Action constants (21)** | `ACTION_CREATE_COLLECTION`, `ACTION_MINT`, `ACTION_TRANSFER`, `ACTION_BULK_DISTRIBUTE`, `ACTION_SET_DATA`, `ACTION_EXTEND_SCHEMA`, `ACTION_ARCHIVE_COLLECTION`, `ACTION_NODE_REGISTER`, `ACTION_NODE_HEARTBEAT`, `ACTION_NODE_STATE_CHECKPOINT`, `ACTION_LIST`, `ACTION_UNLIST`, `ACTION_BUY_COMMITMENT`, `ACTION_BUY`, `ACTION_NFT_APPROVE`, `ACTION_NFT_APPROVE_ALL`, `ACTION_NFT_TRANSFER_FROM`, `ACTION_NFT_LEND`, `ACTION_NFT_RETURN`, `ACTION_DATA_OPERATOR_APPROVE`, `ACTION_SET_DATA_FROM` |
